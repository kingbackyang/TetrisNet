...
parser.add_argument('--image_path', default='datasets/CROHME/16_test_images.pkl', type=str, help='测试image路径')
parser.add_argument('--label_path', default='datasets/CROHME/16_test_labels.txt', type=str, help='测试label路径')
parser.add_argument('--word_path', default='datasets/CROHME/words_dict.txt', type=str, help='测试dict路径')

parser.add_argument('--draw_map', default=True)
...
with open(f'{params["decoder"]["net"]}_bad_case_56.json','w') as f:
